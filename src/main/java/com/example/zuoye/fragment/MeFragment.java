...
import com.example.moni.adapter.Rec_MeAdapter;
import com.example.moni.model.bean.MeBean;
...
public class MeFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        tvMeName.setText("史云青");
        Glide.with(getActivity()).load(R.mipmap.a).apply(new RequestOptions().circleCrop()).into(ivMeTouxiang);
    }
}
